...
class ProductDetailViewController: BaseViewController {
    ...
    init () {
        ...
        scrollView?.bounces = false  //控制控件遇到边框是否反弹
        ...
        //线
        buildLineView(CGRectMake(0, 99, ScreenWidth, 1), addView: detailView!)
        ...
        //线
        buildLineView(CGRectMake(0, ScreenHeight - 51 - NavgationH, ScreenWidth, 1), addView: view)
        
        bottomView = UIView(frame: CGRectMake(0, ScreenHeight - 50 - NavgationH, ScreenWidth, 50))
    ...
    convenience init(goods: Goods) {
        ...
        scrollView?.contentSize = CGSizeMake(ScreenWidth, CGRectGetMaxY(detailImageView!.frame) + 50 + NavgationH)
        
        //设置顶部Navigation
        buildNavigationItem(goods.name!)
        
        //下面的购买view：有个购物车那个view
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        navigationController?.navigationBar.tintColor = LFBNavigationBarWhiteBackgroundColor
        ...
        (navigationController as! BaseNavigationViewController).isAnimation = true
    }
