...
class CouponCell: UITableViewCell {
    ...
    static private let cellIdentifier = "couponCell"
    ...
    class func cellWithTableView(tableView: UITableView) -> CouponCell {
        ...
        if cell == nil {
            ...
            cell = CouponCell(style: .Default, reuseIdentifier: cellIdentifier)
        }
        return cell!
    }
    ...
    private func setCouponColor(isUse: Bool) {
        ...
        tmpView.backgroundColor = isUse ? NavgationYellowColor : UIColor.colorWithCustom(210, g: 210, b: 210)
