...
class OrderStatusCell: UITableViewCell {
    ...
    var orderStatus: OrderStatus? {
        ...
        didSet {
            ...
            subTitleLabel?.text = orderStatus?.status_desc
            ...
            if orderStatus?.status_desc?.characters.count > 0 {
                ...
                if tmpStr.length > 10 {
                    ...
                    if str.isEqualToString("下单成功，") {
                        ...
                        subTitleLabel?.text = mutableStr as String
                    }
                }
            }
        }
    ...
    override func layoutSubviews() {
        ...
        subTitleLabel?.frame = CGRectMake(titleLabel!.x, CGRectGetMaxY(titleLabel!.frame) + 10, width - titleLabel!.frame.origin.x, 30)
