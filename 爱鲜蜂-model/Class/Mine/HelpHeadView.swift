...
@objc protocol HelpHeadViewDelegate: NSObjectProtocol {
   ...
   optional func HelpHeadViewDidClick(headView: HelpHeadView)
}
...
class HelpHeadView: UITableViewHeaderFooterView {
    ...
    func headViewDidClick(tap: UITapGestureRecognizer) {
        ...
        if delegate != nil && delegate!.respondsToSelector("HelpHeadViewDidClick:") {
        
            delegate!.HelpHeadViewDidClick!(self)
